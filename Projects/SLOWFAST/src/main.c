...
__IO uint8_t OperatingMode = Mode_Slow;
...
__IO uint32_t Freq = 20;			// Frequency in Hz for SysTick

float fNormAcc,fSinRoll,fCosRoll,fSinPitch,fCosPitch = 0.0f, RollAng = 0.0f, PitchAng = 0.0f;
float fTiltedX,fTiltedY = 0.0f;

__IO uint16_t ADC_Result[9];
...
void ADC_DMA_Config()
{
  ...
  ADC_RegularChannelConfig(ADC1, ADC_Channel_6, 5, ADC_SampleTime_7Cycles5);
  ADC_RegularChannelConfig(ADC1, ADC_Channel_7, 6, ADC_SampleTime_7Cycles5);
  ...
  ADC_RegularChannelConfig(ADC1, ADC_Channel_10, 9, ADC_SampleTime_7Cycles5);
  ...
  ADC_Result[0] = ADC_GetConversionValue(ADC1);
}
